...
Я выбрал второй вариант, правда решил не запариваться излишним сжатием данных.
...
Этот способ используется уже в моем мессенджере: мы создаем объект (или ту же мапу) с
...
с эмодзями и гонимся за минимизированием передачи данных.

Но возможно в плане производительности это будет работать даже хуже, чем css в лоб,
